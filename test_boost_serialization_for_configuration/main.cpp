...
int main(int argc, char** argv)
{
	...
	//CONFIG_WRITER->initialize( argv[0], false);
	...
	//CONFIG_WRITER->set("APManagerState.APConnected.MillisecondsToWait", 15000);
	//int tempXXX = CONFIG_WRITER->get<int>("APManagerState.APConnected.MillisecondsToWait");
