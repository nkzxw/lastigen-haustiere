...
//
//
////[IODescription("FSWDesc"), DefaultEvent("Changed"), PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust"), PermissionSet(SecurityAction.LinkDemand, Name="FullTrust")]
//class FSW //: Component, ISupportInitialize
//{
//    // Fields
...
//					flag = ReadDirectoryChangesW(pMonitor->hDir,       pMonitor->buffer, sizeof(pMonitor->buffer), FALSE, pMonitor->notifyFilter, NULL, &pMonitor->ol, NULL);
//
//
//					
...
//    }
//
//    [Browsable(false), DefaultValue((string)null), IODescription("FSW_SynchronizingObject")]
